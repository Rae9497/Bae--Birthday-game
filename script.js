...
const steps = [
  ...
  },
  {
    ...
    options: [
      `【火種】<br>一點燃，就會出現炭火的聲音與香氣。<br>那是故事最早開始的傍晚。<br>你不確定那時候算不算心動，<br>但你知道——<br>那天以後，就不一樣了。`,
      `【指南針】<br>指針不指北，指向一條跨越半個地球的公路<br>沿途有期待、有夜色、有被觸及到的感動<br>你以為你記得的是風景，<br>其實你記得的是，我們當時的笑聲`,
